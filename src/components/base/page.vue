<template>
  ...
  <select name="limit"
    ...
    <a href=""
       ...
       @click.prevent="handlerPageChange(1)">首页</a>
    <a href=""
       class="page-item"
       :class="{ disabled: curPage === 1 }"
       @click.prevent="handlerPageChange(curPage - 1)">上一页</a>
    <a href=""
       class="page-item"
    ...
    <a href=""
       ...
       @click.prevent="handlerPageChange(curPage + 1)">下一页</a>
    <a href=""
       class="page-item"
       :class="{ disabled: curPage === totalPage }"
       @click.prevent="handlerPageChange(totalPage)">尾页</a>
    <span class="total">
      <i>{{ curPage }}</i>/
      <i>{{ totalPage }}</i>
    </span>
